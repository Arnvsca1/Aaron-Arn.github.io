      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <input type="button" onclick="location.href='frontpage.php'" value="Go to Homepage" class="btn btn-primary"/>
            </li>
            <li class="nav-item" style="margin-left:10px";>
            <input type="button" onclick="location.href='xmlgenerator.php'" value="Generate XML FILE" class="btn btn-primary"/>
            </li>
            <li class="nav-item">
